									...
									<div class="col-md-6">
										<div class="form-group">
											<label for="lname">Last Name</label> <input type="text"
												...
												name="lname" onblur="check_lname();"> <span
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label for="email">Contact</label> <input type="tel"
												...
												name="contact" onblur="check_contact();" minlength="10" Maxlength="10"> <span
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label for="email">Email</label> <input type="text"
												...
												onblur="searchInfo()"> <span id="tops"
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label for="email">Address</label> <input type="text"
												...
												name="address" onblur="check_address();">
												 <span
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label for="email">Password</label> <input type="password"
												...
												name="password" onblur="check_password();">
												 <span
