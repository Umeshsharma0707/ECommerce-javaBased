		...
		<div class="breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="bread">
							<span><a href="seller-index.jsp">Home</a></span> / <span>Upload Product</span>
						</p>
					</div>
				</div>
			</div>
							...
							<form action="ProductController" class="contact-form"
								...
								<div class="row">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<div class="mb-12">
												<select class="form-control" aria-label=".form-select-lg example" name="pcategory">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<div class="mb-12">
												<select class="form-control" aria-label=".form-select-lg example" name="ptype">
													<option  selected="selected" disabled="disabled">Select Type</option>
													<option value="sports">Sports</option>
													<option value="partywere">Party Were</option>
													<option value="casual">Casual</option>
													<option value="loofer">LOOFER</option>
													<option value="heels">HEELS</option>
													<option value="coneheels">Cone Heels</option>
													<option value="hightops">High Tops</option>
												</select>
											</div>
										</div>
									</div>
