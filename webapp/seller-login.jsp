								...
								<div class="row">
									...
									<div class="col-sm-12">
										<div class="form-group">
											...
											<input type="password" id="email" class="form-control" placeholder="Your Password" name="password">
										</div>
									</div>
									...
									<div class="col-sm-12">
										<div class="form-group">
											<input type="submit" value="login" class="btn btn-primary" name="action">
										</div>
									</div>
									<div>
										<div>
											<h5><a href="seller-forgot-password.jsp">Forgot Password</a></h5>
										</div>
									</div>
								</div>
							</form>	
