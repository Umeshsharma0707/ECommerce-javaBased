								...
								<div class="col-sm-6 offset-sm-3 text-center slider-text">
									<div class="slider-text-inner">
										<div class="desc">
											...
											<p>
												<a href="men.jsp" class="btn btn-primary">Shop Collection</a>
											</p>
										</div>
									</div>
								</div>
								...
								<div class="col-sm-6 offset-sm-3 text-center slider-text">
									<div class="slider-text-inner">
										<div class="desc">
											...
											<p>
												<a href="women.jsp" class="btn btn-primary">Shop Collection</a>
											</p>
										</div>
									</div>
								</div>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-sm-6 text-center">
						<div class="featured">
							<a href="men.jsp" class="featured-img"
								style="background-image: url(images/men.jpg);"></a>
							<div class="desc">
								<h2>
									<a href="men.jsp">Shop Men's Collection</a>
								</h2>
							</div>
						</div>
					</div>
					<div class="col-sm-6 text-center">
						<div class="featured">
							<a href="women.jsp" class="featured-img"
								style="background-image: url(images/women.jpg);"></a>
							<div class="desc">
								<h2>
									<a href="women.jsp">Shop Women's Collection</a>
								</h2>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							...
							<div class="desc">
								...
								<span class="price"><a href="#"><%=p.getPprice()%> &#8377;</a></span>
							</div>
							<div class="">
